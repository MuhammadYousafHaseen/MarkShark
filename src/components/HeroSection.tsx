...
{/* Responsive Video Wrapper with Margin */}
<div className="absolute inset-0 w-full h-full px-2 sm:px-4 md:px-6 py-2 sm:py-4 md:py-6 pointer-events-none z-0">
  <video
...
<div className="relative z-10 flex flex-col items-center text-center px-4 py-20 sm:py-24 md:py-28 lg:py-32">
  ...
  <Link href="/contact" passHref>
    <div
      className={`inline-block mt-10 px-8 py-4 sm:px-12 sm:py-5 md:px-16 md:py-6 bg-[#99FF33] hover:bg-[#7ACC28] text-black font-extrabold uppercase text-2xl sm:text-3xl md:text-2xl rounded-full shadow-xl transition`}
    >
      Tell Me How ?
    </div>
  </Link>
